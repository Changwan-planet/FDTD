...
#Path
input_path1="/home/changwan/FDTD/FDTD_3D_E.txt"
#input_path2="/home/changwan/FDTD/FDTD_3D_H.txt"
input_path3="/home/changwan/FDTD/Source_3D.txt"
input_path4="/home/changwan/FDTD/FDTD_3D_E1.txt"
...
S2=np.loadtxt(input_path3,usecols=1)
S3=np.loadtxt(input_path3,usecols=2)
...
E12=np.loadtxt(input_path4, usecols=1)
E13=np.loadtxt(input_path4, usecols=2)
#"""

"""
#H = Final output
H1=np.loadtxt(input_path2, usecols=0)
H2=np.loadtxt(input_path2, usecols=1)
H3=np.loadtxt(input_path2, usecols=2)
...
plt.subplot(2,2,3)
plt.plot(E11,'ro',label='E_x_field')
